...
const Manager = () => {
    ...
    const savePassword = () => {
        if (form.site.length > 3 && form.username.length > 3 && form.password.length > 3) {
            ...
            toast.error('Website, Username & Password should be atleast 4 characters', {
                position: "top-right",
                autoClose: 4000,
                hideProgressBar: false,
                closeOnClick: false,
    ...
    return (
        <>
            ...
            {/* Same as */}
            <ToastContainer />
            <div className="absolute inset-0 -z-10 h-full w-full bg-black bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:14px_24px]"><div className="absolute left-0 right-0 top-0 -z-10 m-auto h-[310px] w-[310px] rounded-full bg-black opacity-20 blur-[100px]"></div></div>
            <div className=" p-3 md:mycontainer min-h-[83vh] ">
                <h1 className='text-4xl text font-bold text-center'>
                    <span className='text-purple-700'> &lt;</span>

                    <span className='text-white'>Pass</span><span className='text-purple-700'>Guard/&gt;</span>
                ...
                <div className="flex flex-col p-4 text-black gap-8 items-center">
                    ...
                    <button onClick={savePassword} className='flex justify-center items-center gap-2 bg-purple-700 hover:bg-purple-500 rounded-full px-8 py-2 w-fit border border-purple-900 text-white'>
